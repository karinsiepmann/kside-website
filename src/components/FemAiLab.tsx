  ...
  return (
    <section id="femailab" className="py-24 bg-green-light">
      <div className="max-w-6xl mx-auto px-8">
        ...
        <h2 className="text-4xl font-bold mb-12 text-burgundy">Ai Open Learning Lab for Women im Zukunftswerk</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden shadow-md">
            <Image
              ...
              alt="Ai Open Learning Lab for Women im Zukunftswerk Wiesbaden"
              fill
