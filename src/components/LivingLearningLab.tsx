        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-8">
              Neue Lernimpulse entstehen regelmäßig, um dich zu neuen Fragen zu inspirieren.
            </p>
            <a
              href="/livinglearninglab/"
              className="inline-block px-7 py-3 rounded-full font-semibold text-white bg-[#F0762B] hover:opacity-90 transition-opacity"
            >
              Zur Lernreise
            </a>
          </div>

          <div className="bg-white rounded-xl p-8 shadow-md border-t-4 border-[#F0762B]">
